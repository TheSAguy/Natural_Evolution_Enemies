...
--NE_Enemies.Settings.NE_Alien_Artifacts = NE_Enemies.Settings.startup["NE_Alien_Artifacts"].value
...
function Spawn_Worm_Larva(entity)
    ...
    local PositionValid = entity.surface.find_non_colliding_position(
        Worm_Name, entity.position, 2, 0.5, 0.01)
