            ...
            ["NE Enemies"] = {
                ...
                milestones = {
                   ...
                   NE_Enemies.Settings.NE_Alien_Artifact_Eggs and
                    {type="kill", name="ne-base-larva-worm",     quantity=1} or nil,
                    NE_Enemies.Settings.NE_Alien_Artifact_Eggs and
                      {type="kill", name="ne-base-larva-worm",     quantity=100, next="x10"} or nil,
                   {type="kill", name="ne-spawner-blue",     quantity=1},
                   {type="kill", name="ne-spawner-blue",     quantity=100, next="x10"},
                   {type="kill", name="ne-spawner-red",     quantity=1},
                   {type="kill", name="ne-spawner-red",     quantity=100, next="x10"},
                   {type="kill", name="ne-spawner-green",     quantity=1},
                   {type="kill", name="ne-spawner-green",     quantity=100, next="x10"},
                   {type="kill", name="ne-spawner-yellow",     quantity=1},
                   {type="kill", name="ne-spawner-yellow",     quantity=100, next="x10"},
                   {type="kill", name="ne-spawner-pink",     quantity=1},
                   {type="kill", name="ne-spawner-pink",     quantity=100, next="x10"},
               }
            }
        }
    end
