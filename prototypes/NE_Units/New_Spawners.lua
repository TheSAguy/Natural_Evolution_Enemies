...
data:extend({{
    ...
    spawning_cooldown = {(200 + (100 / NE_Enemies.Settings.NE_Difficulty)),
                         (100 + (50 / NE_Enemies.Settings.NE_Difficulty))}, -- v {360, 150},
...
if settings.startup["NE_Blue_Spawners"].value then
    ...
    NE_Unit_Spawner_Blue.result_units = (function()
        ...
        elseif settings.startup["NE_Biter_Breeder"].value == true and settings.startup["NE_Spitter_Breeder"].value == false then
            res[1] = {"ne-biter-breeder-1", {{0, 0.1}, {0.1, 0.3}, {0.2, 0}}}
            res[2] = {"ne-biter-breeder-2", {{0.05, 0}, {0.15, 0.3}, {0.25, 0}}}
            res[3] = {"ne-biter-breeder-3", {{0.1, 0}, {0.2, 0.3}, {0.3, 0}}}
            res[4] = {"ne-biter-breeder-4", {{0.15, 0}, {0.25, 0.3}, {0.35, 0}}}
            res[5] = {"ne-biter-breeder-5", {{0.2, 0}, {0.3, 0.3}, {0.4, 0}}}
            res[6] = {"ne-biter-breeder-6", {{0.25, 0}, {0.35, 0.3}, {0.45, 0}}}
            res[7] = {"ne-biter-breeder-7", {{0.3, 0}, {0.4, 0.3}, {0.5, 0}}}
            res[8] = {"ne-biter-breeder-8", {{0.35, 0}, {0.45, 0.3}, {0.55, 0}}}
            res[9] = {"ne-biter-breeder-9", {{0.4, 0}, {0.5, 0.3}, {0.6, 0}}}
            res[10] = {"ne-biter-breeder-10", {{0.45, 0}, {0.55, 0.3}, {0.65, 0}}}
            res[11] = {"ne-biter-breeder-11", {{0.5, 0}, {0.6, 0.3}, {0.7, 0}}}
            res[12] = {"ne-biter-breeder-12", {{0.55, 0}, {0.65, 0.3}, {0.75, 0}}}
            res[13] = {"ne-biter-breeder-13", {{0.6, 0}, {0.7, 0.3}, {0.8, 0}}}
            res[14] = {"ne-biter-breeder-14", {{0.65, 0}, {0.75, 0.3}, {0.85, 0}}}
            res[15] = {"ne-biter-breeder-15", {{0.7, 0}, {0.8, 0.3}, {0.9, 0}}}
            res[16] = {"ne-biter-breeder-16", {{0.75, 0}, {0.85, 0.3}, {0.95, 0}}}
            res[17] = {"ne-biter-breeder-17", {{0.8, 0}, {0.9, 0.3}, {0.99, 0}}}
            res[18] = {"ne-biter-breeder-18", {{0.85, 0}, {0.95, 0.3}, {0.99, 0}}}
            res[19] = {"ne-biter-breeder-19", {{0.9, 0}, {1, 0.1}}}
            res[20] = {"ne-biter-breeder-20", {{0.95, 0}, {1, 0.2}}}
            if settings.startup["NE_Challenge_Mode"].value == true then
                res[21] = {"ne-biter-megalodon", {{0.98, 0.1}, {1, 0.5}}}
            end
        elseif settings.startup["NE_Biter_Breeder"].value == false and settings.startup["NE_Spitter_Breeder"].value == true then
            res[1] = {"ne-spitter-breeder-1", {{0.025, 0}, {0.125, 0.3}, {0.225, 0}}}
            res[2] = {"ne-spitter-breeder-2", {{0.075, 0}, {0.175, 0.3}, {0.275, 0}}}
            res[3] = {"ne-spitter-breeder-3", {{0.125, 0}, {0.225, 0.3}, {0.325, 0}}}
            res[4] = {"ne-spitter-breeder-4", {{0.175, 0}, {0.275, 0.3}, {0.375, 0}}}
            res[5] = {"ne-spitter-breeder-5", {{0.225, 0}, {0.325, 0.3}, {0.425, 0}}}
            res[6] = {"ne-spitter-breeder-6", {{0.275, 0}, {0.375, 0.3}, {0.475, 0}}}
            res[7] = {"ne-spitter-breeder-7", {{0.325, 0}, {0.425, 0.3}, {0.525, 0}}}
            res[8] = {"ne-spitter-breeder-8", {{0.375, 0}, {0.475, 0.3}, {0.575, 0}}}
            res[9] = {"ne-spitter-breeder-9", {{0.425, 0}, {0.525, 0.3}, {0.625, 0}}}
            res[10] = {"ne-spitter-breeder-10", {{0.475, 0}, {0.575, 0.3}, {0.675, 0}}}
            res[11] = {"ne-spitter-breeder-11", {{0.525, 0}, {0.625, 0.3}, {0.725, 0}}}
            res[12] = {"ne-spitter-breeder-12", {{0.575, 0}, {0.675, 0.3}, {0.775, 0}}}
            res[13] = {"ne-spitter-breeder-13", {{0.625, 0}, {0.725, 0.3}, {0.825, 0}}}
            res[14] = {"ne-spitter-breeder-14", {{0.675, 0}, {0.775, 0.3}, {0.875, 0}}}
            res[15] = {"ne-spitter-breeder-15", {{0.725, 0}, {0.825, 0.3}, {0.925, 0}}}
            res[16] = {"ne-spitter-breeder-16", {{0.775, 0}, {0.875, 0.3}, {0.975, 0}}}
            res[17] = {"ne-spitter-breeder-17", {{0.825, 0}, {0.925, 0.3}, {0.99, 0}}}
            res[18] = {"ne-spitter-breeder-18", {{0.875, 0}, {0.975, 0.3}, {0.99, 0}}}
            res[19] = {"ne-spitter-breeder-19", {{0.925, 0}, {1, 0.15}}}
            res[20] = {"ne-spitter-breeder-20", {{0.975, 0}, {1, 0.25}}}
            if settings.startup["NE_Challenge_Mode"].value == true then
                res[21] = {"ne-biter-megalodon", {{0.98, 0.1}, {1, 0.5}}}
            end
        else
...
if settings.startup["NE_Red_Spawners"].value then
    ...
    NE_Unit_Spawner_Red.animations = {spawner_idle_animation(0, ne_fire_tint2),
                                      spawner_idle_animation(1, ne_fire_tint2),
                                      spawner_idle_animation(2, ne_fire_tint2), spawner_idle_animation(3, ne_fire_tint2)}
    NE_Unit_Spawner_Red.result_units = (function()
        local res = {}
        if settings.startup["NE_Biter_Fire"].value == true and settings.startup["NE_Spitter_Fire"].value == true then
        ...
        elseif settings.startup["NE_Biter_Fire"].value == true and settings.startup["NE_Spitter_Fire"].value == false then
            res[1] = {"ne-biter-fire-1", {{0, 0.1}, {0.1, 0.3}, {0.2, 0}}}
            res[2] = {"ne-biter-fire-2", {{0.05, 0}, {0.15, 0.3}, {0.25, 0}}}
            res[3] = {"ne-biter-fire-3", {{0.1, 0}, {0.2, 0.3}, {0.3, 0}}}
            res[4] = {"ne-biter-fire-4", {{0.15, 0}, {0.25, 0.3}, {0.35, 0}}}
            res[5] = {"ne-biter-fire-5", {{0.2, 0}, {0.3, 0.3}, {0.4, 0}}}
            res[6] = {"ne-biter-fire-6", {{0.25, 0}, {0.35, 0.3}, {0.45, 0}}}
            res[7] = {"ne-biter-fire-7", {{0.3, 0}, {0.4, 0.3}, {0.5, 0}}}
            res[8] = {"ne-biter-fire-8", {{0.35, 0}, {0.45, 0.3}, {0.55, 0}}}
            res[9] = {"ne-biter-fire-9", {{0.4, 0}, {0.5, 0.3}, {0.6, 0}}}
            res[10] = {"ne-biter-fire-10", {{0.45, 0}, {0.55, 0.3}, {0.65, 0}}}
            res[11] = {"ne-biter-fire-11", {{0.5, 0}, {0.6, 0.3}, {0.7, 0}}}
            res[12] = {"ne-biter-fire-12", {{0.55, 0}, {0.65, 0.3}, {0.75, 0}}}
            res[13] = {"ne-biter-fire-13", {{0.6, 0}, {0.7, 0.3}, {0.8, 0}}}
            res[14] = {"ne-biter-fire-14", {{0.65, 0}, {0.75, 0.3}, {0.85, 0}}}
            res[15] = {"ne-biter-fire-15", {{0.7, 0}, {0.8, 0.3}, {0.9, 0}}}
            res[16] = {"ne-biter-fire-16", {{0.75, 0}, {0.85, 0.3}, {0.95, 0}}}
            res[17] = {"ne-biter-fire-17", {{0.8, 0}, {0.9, 0.3}, {0.99, 0}}}
            res[18] = {"ne-biter-fire-18", {{0.85, 0}, {0.95, 0.3}, {0.99, 0}}}
            res[19] = {"ne-biter-fire-19", {{0.9, 0}, {1, 0.1}}}
            res[20] = {"ne-biter-fire-20", {{0.95, 0}, {1, 0.2}}}
            if settings.startup["NE_Challenge_Mode"].value == true then
                res[21] = {"ne-biter-megalodon", {{0.98, 0.1}, {1, 0.5}}}
            end
        elseif settings.startup["NE_Biter_Fire"].value == false and settings.startup["NE_Spitter_Fire"].value == true then
            res[1] = {"ne-spitter-fire-1", {{0.025, 0}, {0.125, 0.3}, {0.225, 0}}}
            res[2] = {"ne-spitter-fire-2", {{0.075, 0}, {0.175, 0.3}, {0.275, 0}}}
            res[3] = {"ne-spitter-fire-3", {{0.125, 0}, {0.225, 0.3}, {0.325, 0}}}
            res[4] = {"ne-spitter-fire-4", {{0.175, 0}, {0.275, 0.3}, {0.375, 0}}}
            res[5] = {"ne-spitter-fire-5", {{0.225, 0}, {0.325, 0.3}, {0.425, 0}}}
            res[6] = {"ne-spitter-fire-6", {{0.275, 0}, {0.375, 0.3}, {0.475, 0}}}
            res[7] = {"ne-spitter-fire-7", {{0.325, 0}, {0.425, 0.3}, {0.525, 0}}}
            res[8] = {"ne-spitter-fire-8", {{0.375, 0}, {0.475, 0.3}, {0.575, 0}}}
            res[9] = {"ne-spitter-fire-9", {{0.425, 0}, {0.525, 0.3}, {0.625, 0}}}
            res[10] = {"ne-spitter-fire-10", {{0.475, 0}, {0.575, 0.3}, {0.675, 0}}}
            res[11] = {"ne-spitter-fire-11", {{0.525, 0}, {0.625, 0.3}, {0.725, 0}}}
            res[12] = {"ne-spitter-fire-12", {{0.575, 0}, {0.675, 0.3}, {0.775, 0}}}
            res[13] = {"ne-spitter-fire-13", {{0.625, 0}, {0.725, 0.3}, {0.825, 0}}}
            res[14] = {"ne-spitter-fire-14", {{0.675, 0}, {0.775, 0.3}, {0.875, 0}}}
            res[15] = {"ne-spitter-fire-15", {{0.725, 0}, {0.825, 0.3}, {0.925, 0}}}
            res[16] = {"ne-spitter-fire-16", {{0.775, 0}, {0.875, 0.3}, {0.975, 0}}}
            res[17] = {"ne-spitter-fire-17", {{0.825, 0}, {0.925, 0.3}, {0.99, 0}}}
            res[18] = {"ne-spitter-fire-18", {{0.875, 0}, {0.975, 0.3}, {0.99, 0}}}
            res[19] = {"ne-spitter-fire-19", {{0.925, 0}, {1, 0.15}}}
            res[20] = {"ne-spitter-fire-20", {{0.975, 0}, {1, 0.25}}}
            if settings.startup["NE_Challenge_Mode"].value == true then
                res[21] = {"ne-biter-megalodon", {{0.98, 0.1}, {1, 0.5}}}
            end
        else
...
if settings.startup["NE_Green_Spawners"].value then
    ...
    NE_Unit_Spawner_Green.result_units = (function()
        local res = {}
        if settings.startup["NE_Biter_Fast"].value == true and settings.startup["NE_Spitter_Ulaunch"].value == true then
        ...
        elseif settings.startup["NE_Biter_Fast"].value == true and settings.startup["NE_Spitter_Ulaunch"].value == false then
            res[1] = {"ne-biter-fast-1", {{0, 0.1}, {0.1, 0.3}, {0.2, 0}}}
            res[2] = {"ne-biter-fast-2", {{0.05, 0}, {0.15, 0.3}, {0.25, 0}}}
            res[3] = {"ne-biter-fast-3", {{0.1, 0}, {0.2, 0.3}, {0.3, 0}}}
            res[4] = {"ne-biter-fast-4", {{0.15, 0}, {0.25, 0.3}, {0.35, 0}}}
            res[5] = {"ne-biter-fast-5", {{0.2, 0}, {0.3, 0.3}, {0.4, 0}}}
            res[6] = {"ne-biter-fast-6", {{0.25, 0}, {0.35, 0.3}, {0.45, 0}}}
            res[7] = {"ne-biter-fast-7", {{0.3, 0}, {0.4, 0.3}, {0.5, 0}}}
            res[8] = {"ne-biter-fast-8", {{0.35, 0}, {0.45, 0.3}, {0.55, 0}}}
            res[9] = {"ne-biter-fast-9", {{0.4, 0}, {0.5, 0.3}, {0.6, 0}}}
            res[10] = {"ne-biter-fast-10", {{0.45, 0}, {0.55, 0.3}, {0.65, 0}}}
            res[11] = {"ne-biter-fast-11", {{0.5, 0}, {0.6, 0.3}, {0.7, 0}}}
            res[12] = {"ne-biter-fast-12", {{0.55, 0}, {0.65, 0.3}, {0.75, 0}}}
            res[13] = {"ne-biter-fast-13", {{0.6, 0}, {0.7, 0.3}, {0.8, 0}}}
            res[14] = {"ne-biter-fast-14", {{0.65, 0}, {0.75, 0.3}, {0.85, 0}}}
            res[15] = {"ne-biter-fast-15", {{0.7, 0}, {0.8, 0.3}, {0.9, 0}}}
            res[16] = {"ne-biter-fast-16", {{0.75, 0}, {0.85, 0.3}, {0.95, 0}}}
            res[17] = {"ne-biter-fast-17", {{0.8, 0}, {0.9, 0.3}, {0.99, 0}}}
            res[18] = {"ne-biter-fast-18", {{0.85, 0}, {0.95, 0.3}, {0.99, 0}}}
            res[19] = {"ne-biter-fast-19", {{0.9, 0}, {1, 0.1}}}
            res[20] = {"ne-biter-fast-20", {{0.95, 0}, {1, 0.2}}}
            if settings.startup["NE_Challenge_Mode"].value == true then
                res[21] = {"ne-biter-megalodon", {{0.98, 0.1}, {1, 0.5}}}
            end
        elseif settings.startup["NE_Biter_Fast"].value == false and settings.startup["NE_Spitter_Ulaunch"].value == true then
            res[1] = {"ne-spitter-ulaunch-1", {{0.025, 0}, {0.125, 0.3}, {0.225, 0}}}
            res[2] = {"ne-spitter-ulaunch-2", {{0.075, 0}, {0.175, 0.3}, {0.275, 0}}}
            res[3] = {"ne-spitter-ulaunch-3", {{0.125, 0}, {0.225, 0.3}, {0.325, 0}}}
            res[4] = {"ne-spitter-ulaunch-4", {{0.175, 0}, {0.275, 0.3}, {0.375, 0}}}
            res[5] = {"ne-spitter-ulaunch-5", {{0.225, 0}, {0.325, 0.3}, {0.425, 0}}}
            res[6] = {"ne-spitter-ulaunch-6", {{0.275, 0}, {0.375, 0.3}, {0.475, 0}}}
            res[7] = {"ne-spitter-ulaunch-7", {{0.325, 0}, {0.425, 0.3}, {0.525, 0}}}
            res[8] = {"ne-spitter-ulaunch-8", {{0.375, 0}, {0.475, 0.3}, {0.575, 0}}}
            res[9] = {"ne-spitter-ulaunch-9", {{0.425, 0}, {0.525, 0.3}, {0.625, 0}}}
            res[10] = {"ne-spitter-ulaunch-10", {{0.475, 0}, {0.575, 0.3}, {0.675, 0}}}
            res[11] = {"ne-spitter-ulaunch-11", {{0.525, 0}, {0.625, 0.3}, {0.725, 0}}}
            res[12] = {"ne-spitter-ulaunch-12", {{0.575, 0}, {0.675, 0.3}, {0.775, 0}}}
            res[13] = {"ne-spitter-ulaunch-13", {{0.625, 0}, {0.725, 0.3}, {0.825, 0}}}
            res[14] = {"ne-spitter-ulaunch-14", {{0.675, 0}, {0.775, 0.3}, {0.875, 0}}}
            res[15] = {"ne-spitter-ulaunch-15", {{0.725, 0}, {0.825, 0.3}, {0.925, 0}}}
            res[16] = {"ne-spitter-ulaunch-16", {{0.775, 0}, {0.875, 0.3}, {0.975, 0}}}
            res[17] = {"ne-spitter-ulaunch-17", {{0.825, 0}, {0.925, 0.3}, {0.99, 0}}}
            res[18] = {"ne-spitter-ulaunch-18", {{0.875, 0}, {0.975, 0.3}, {0.99, 0}}}
            res[19] = {"ne-spitter-ulaunch-19", {{0.925, 0}, {1, 0.15}}}
            res[20] = {"ne-spitter-ulaunch-20", {{0.975, 0}, {1, 0.25}}}
            if settings.startup["NE_Challenge_Mode"].value == true then
                res[21] = {"ne-biter-megalodon", {{0.98, 0.1}, {1, 0.5}}}
            end
        else
...
if settings.startup["NE_Yellow_Spawners"].value then
    ...
    NE_Unit_Spawner_Yellow.result_units = (function()
        local res = {}
        if settings.startup["NE_Biter_Wallbreaker"].value == true and settings.startup["NE_Spitter_Webshooter"].value == true then
        ...
        elseif settings.startup["NE_Biter_Wallbreaker"].value == true and settings.startup["NE_Spitter_Webshooter"].value == false then
            res[1] = {"ne-biter-wallbreaker-1", {{0, 0.1}, {0.1, 0.3}, {0.2, 0}}}
            res[2] = {"ne-biter-wallbreaker-2", {{0.05, 0}, {0.15, 0.3}, {0.25, 0}}}
            res[3] = {"ne-biter-wallbreaker-3", {{0.1, 0}, {0.2, 0.3}, {0.3, 0}}}
            res[4] = {"ne-biter-wallbreaker-4", {{0.15, 0}, {0.25, 0.3}, {0.35, 0}}}
            res[5] = {"ne-biter-wallbreaker-5", {{0.2, 0}, {0.3, 0.3}, {0.4, 0}}}
            res[6] = {"ne-biter-wallbreaker-6", {{0.25, 0}, {0.35, 0.3}, {0.45, 0}}}
            res[7] = {"ne-biter-wallbreaker-7", {{0.3, 0}, {0.4, 0.3}, {0.5, 0}}}
            res[8] = {"ne-biter-wallbreaker-8", {{0.35, 0}, {0.45, 0.3}, {0.55, 0}}}
            res[9] = {"ne-biter-wallbreaker-9", {{0.4, 0}, {0.5, 0.3}, {0.6, 0}}}
            res[10] = {"ne-biter-wallbreaker-10", {{0.45, 0}, {0.55, 0.3}, {0.65, 0}}}
            res[11] = {"ne-biter-wallbreaker-11", {{0.5, 0}, {0.6, 0.3}, {0.7, 0}}}
            res[12] = {"ne-biter-wallbreaker-12", {{0.55, 0}, {0.65, 0.3}, {0.75, 0}}}
            res[13] = {"ne-biter-wallbreaker-13", {{0.6, 0}, {0.7, 0.3}, {0.8, 0}}}
            res[14] = {"ne-biter-wallbreaker-14", {{0.65, 0}, {0.75, 0.3}, {0.85, 0}}}
            res[15] = {"ne-biter-wallbreaker-15", {{0.7, 0}, {0.8, 0.3}, {0.9, 0}}}
            res[16] = {"ne-biter-wallbreaker-16", {{0.75, 0}, {0.85, 0.3}, {0.95, 0}}}
            res[17] = {"ne-biter-wallbreaker-17", {{0.8, 0}, {0.9, 0.3}, {0.99, 0}}}
            res[18] = {"ne-biter-wallbreaker-18", {{0.85, 0}, {0.95, 0.3}, {0.99, 0}}}
            res[19] = {"ne-biter-wallbreaker-19", {{0.9, 0}, {1, 0.1}}}
            res[20] = {"ne-biter-wallbreaker-20", {{0.95, 0}, {1, 0.2}}}
            if settings.startup["NE_Challenge_Mode"].value == true then
                res[21] = {"ne-biter-megalodon", {{0.98, 0.1}, {1, 0.5}}}
            end
        elseif settings.startup["NE_Biter_Wallbreaker"].value == false and settings.startup["NE_Spitter_Webshooter"].value == true then
            res[1] = {"ne-spitter-webshooter-1", {{0.025, 0}, {0.125, 0.3}, {0.225, 0}}}
            res[2] = {"ne-spitter-webshooter-2", {{0.075, 0}, {0.175, 0.3}, {0.275, 0}}}
            res[3] = {"ne-spitter-webshooter-3", {{0.125, 0}, {0.225, 0.3}, {0.325, 0}}}
            res[4] = {"ne-spitter-webshooter-4", {{0.175, 0}, {0.275, 0.3}, {0.375, 0}}}
            res[5] = {"ne-spitter-webshooter-5", {{0.225, 0}, {0.325, 0.3}, {0.425, 0}}}
            res[6] = {"ne-spitter-webshooter-6", {{0.275, 0}, {0.375, 0.3}, {0.475, 0}}}
            res[7] = {"ne-spitter-webshooter-7", {{0.325, 0}, {0.425, 0.3}, {0.525, 0}}}
            res[8] = {"ne-spitter-webshooter-8", {{0.375, 0}, {0.475, 0.3}, {0.575, 0}}}
            res[9] = {"ne-spitter-webshooter-9", {{0.425, 0}, {0.525, 0.3}, {0.625, 0}}}
            res[10] = {"ne-spitter-webshooter-10", {{0.475, 0}, {0.575, 0.3}, {0.675, 0}}}
            res[11] = {"ne-spitter-webshooter-11", {{0.525, 0}, {0.625, 0.3}, {0.725, 0}}}
            res[12] = {"ne-spitter-webshooter-12", {{0.575, 0}, {0.675, 0.3}, {0.775, 0}}}
            res[13] = {"ne-spitter-webshooter-13", {{0.625, 0}, {0.725, 0.3}, {0.825, 0}}}
            res[14] = {"ne-spitter-webshooter-14", {{0.675, 0}, {0.775, 0.3}, {0.875, 0}}}
            res[15] = {"ne-spitter-webshooter-15", {{0.725, 0}, {0.825, 0.3}, {0.925, 0}}}
            res[16] = {"ne-spitter-webshooter-16", {{0.775, 0}, {0.875, 0.3}, {0.975, 0}}}
            res[17] = {"ne-spitter-webshooter-17", {{0.825, 0}, {0.925, 0.3}, {0.99, 0}}}
            res[18] = {"ne-spitter-webshooter-18", {{0.875, 0}, {0.975, 0.3}, {0.99, 0}}}
            res[19] = {"ne-spitter-webshooter-19", {{0.925, 0}, {1, 0.15}}}
            res[20] = {"ne-spitter-webshooter-20", {{0.975, 0}, {1, 0.25}}}
            if settings.startup["NE_Challenge_Mode"].value == true then
                res[21] = {"ne-biter-megalodon", {{0.98, 0.1}, {1, 0.5}}}
            end
        else
    ...
    NE_Unit_Spawner_Corpse_Yellow.animation = {spawner_die_animation(0, ne_yellow_tint),
...
if settings.startup["NE_Pink_Spawners"].value then
    ...
    NE_Unit_Spawner_Pink.animations = {spawner_idle_animation(0, ne_pink_tint), spawner_idle_animation(1, ne_pink_tint),
