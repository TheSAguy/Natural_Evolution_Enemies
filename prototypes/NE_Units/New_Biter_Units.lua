...
for i = 1, 20 do
    ...
    NE_Biter_Breeder_Unit.resistances = {{
        type = "physical",
        percent = i * 2
    ...
    NE_Biter_Tank_Unit.resistances = {{
        type = "laser",
        percent = i * 5
    ...
    NE_Biter_Fire_Unit_Corpse.time_before_removed = (i / 20 + 2) * 60 * 5
    ...
    NE_Biter_Fast_Unit_Corpse.time_before_removed = (i / 20 + 2) * 60 * 5
